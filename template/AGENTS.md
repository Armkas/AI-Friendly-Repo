...
3. **Domain Knowledge**: `docs/domains/` - Understand business rules and state machines.
4. **Concrete Implementation**: Only enter the code layer directories when troubleshooting specific details.

## Global Invariants
- [TBD]: Please supplement the global business invariants of this project here.
