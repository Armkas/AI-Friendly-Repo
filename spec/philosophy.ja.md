...
## 46. ドキュメントは AI が具体的な問いに答えられるようにする
...
## 47. ナレッジレイヤーはプラットフォーム非依存

iOS のみ、FastAPI のみ、iOS + FastAPI —— ナレッジレイヤーの考え方は変わらない。

## 48. コードレイヤーは実在するシステムに応じて増減する
